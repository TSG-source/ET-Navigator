  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: 'model',
      text: vernacular === 'en' 
        ? "Hi! I'm ET Navigator. How can I help you navigate the business world today?"
        : vernacular === 'hi'
        ? "नमस्ते! मैं ET Navigator हूँ। आज मैं आपको व्यावसायिक दुनिया में नेविगेट करने में कैसे मदद कर सकता हूँ?"
        : "வணக்கம்! நான் ET Navigator. இன்று வணிக உலகில் பயணிக்க நான் உங்களுக்கு எப்படி உதவுவது?",
    },
  ]);
          ...
          >
            ...
            <div className="p-4 bg-et-red text-white flex items-center justify-between shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-bold text-sm font-display italic">ET Navigator</h4>
